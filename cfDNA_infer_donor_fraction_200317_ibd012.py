...
def cal_block_lemmision(donorP_vec, seq_err,
    ...
    lEmission = np.array([ np.sum(np.log( (P_ref_cfDNA_ibd0[ref_cnt_nonzero]*(1-seq_err)) + ((1-P_ref_cfDNA_ibd0[ref_cnt_nonzero])*(seq_err)) ) * ref_cnts) +
                           np.sum(np.log( ((1-P_ref_cfDNA_ibd0[alt_cnt_nonzero])*(1-seq_err)) + (P_ref_cfDNA_ibd0[alt_cnt_nonzero]*(seq_err)) ) * alt_cnts),
                           np.sum(np.log( (P_ref_cfDNA_ibd1[ref_cnt_nonzero]*(1-seq_err)) + ((1-P_ref_cfDNA_ibd1[ref_cnt_nonzero])*(seq_err)) ) * ref_cnts) +
                           np.sum(np.log( ((1-P_ref_cfDNA_ibd1[alt_cnt_nonzero])*(1-seq_err)) + (P_ref_cfDNA_ibd1[alt_cnt_nonzero]*(seq_err)) ) * alt_cnts),
                           np.sum(np.log( (P_ref_cfDNA_ibd2[ref_cnt_nonzero]*(1-seq_err)) + ((1-P_ref_cfDNA_ibd2[ref_cnt_nonzero])*(seq_err)) ) * ref_cnts) +
